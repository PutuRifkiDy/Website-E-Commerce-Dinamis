            ...
            <div class="page-content">
                ...
                <div class="records table-responsive">
                    ...
                    <section class="contact" id="formContainer" style="display:none;">
                        <h1 class="heading" style="text-align:center;margin-top:10px;"><span class="fw-3">Tambah</span>
                            Produk</h1>
                            ...
                            if ($queryJumlahProduk == 0) {
                                ...
                                while ($data = mysqli_fetch_array($queryProduk2Table)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="adminProduk.php?k=<?php echo $data['id']; ?>" class="btn btn-info"
