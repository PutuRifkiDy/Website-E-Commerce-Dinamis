...
if (isset($_GET['keyword'])) {
    $querySubscriber = mysqli_query($con, "SELECT * FROM subscribtion WHERE email LIKE '%$_GET[keyword]%'");
    $banyakSubs = mysqli_num_rows($querySubscriber);
} else {
    $querySubscriber = mysqli_query($con, "SELECT * FROM subscribtion");
    $banyakSubs = mysqli_num_rows($querySubscriber);
        ...
        <div class="side-content">
            ...
            <div class="side-menu">
                <ul>
                    ...
                    <li>
                        <a href="adminSubscriber.php" class="active">
                ...
                <div class="records table-responsive">
                    ...
                    <div class="record-header">
                        ...
                        <div id="#search" class="browse">
                            <form action="adminSubscriber.php" method="get">
                                ...
                                if ($banyakSubs == 0) {
                                    ...
                                    <tr>
                                        <td class="text-center" style="text-align: center;">
                                            Data Subscriber tidak tersedia
                                        </td>
                                    </tr>
                                    <?php
                                } else {
                                    $jumlah = 1;
                                    while ($data = mysqli_fetch_array($querySubscriber)) {
                                        ?>
                                        <tr>
                                            <td>
                                                #
                                            ...
                                            <td>
                                                <a href="deleteSubscriberAdmin.php?id=<?php echo $data['id']; ?>"
