...
<head>
    ...
    <!-- link css -->
    <link rel="stylesheet" href="styleReadMore.css" />
    ...
    <header>
        ...
        <div class="header-2">
            ...
            <div class="icons">
                ...
                <a href="#hub"><i class="fa-regular fa-address-book"></i></a>
            </div>
        </div>
    </header>
    <!-- end header -->
     ...
     <section class="product" id="product">
        <h1 class="heading" style="margin-bottom:1rem;"><span>Detail</span> Product</h1>
        <?php
        if ($countdata < 1) {
            ?>
        ...
        <div class="box-container">
            ...
            <?php while ($produk = mysqli_fetch_array($queryProduk)) { ?>
                ...
                <div class="deskripsi-produk">
                   <h1><span>DESKRIPSI PRODUK</span></h1>
                   <p><?php echo $produk['detail'];?></p>
                   <footer class="modified-dated">last update : <span style="font-style: italic;"><?php echo $produk['tanggal'];?></span></footer>
               </div>
                <?php } ?>
