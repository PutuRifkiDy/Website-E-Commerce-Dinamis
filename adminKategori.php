...
if (isset($_GET['keyword'])) {
    $queryKategori = mysqli_query($con, "SELECT * FROM kategori WHERE nama like '%$_GET[keyword]%'");
        ...
        <div class="side-content">
            ...
            <div class="side-menu">
                <ul>
                    ...
                    <li>
                        <a href="adminKategori.php" class="active">
                ...
                <div class="records table-responsive">
                    ...
                    <div class="record-header">
                        <div class="add">
                            ...
                            <!-- <button><a href="
                                adminUser.php" style="color:white">Add User</a></button> -->
                        </div>

                        <div id="#search" class="browse">
                            <form action="adminKategori.php" method="get">
                                <input id="#search" type="search" placeholder="Search Kategori" class="record-search"
                                ...
                                if ($banyakKategori == 0) {
                                    ...
                                    while ($data = mysqli_fetch_array($queryKategori)) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="adminProduk.php?p=<?php echo $data['id']; ?>" class="btn btn-info"
